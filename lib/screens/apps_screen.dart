...
class AppsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildSearchBar(context, primaryColor, theme),
          _buildFilterPills(context, primaryColor, theme),
          Expanded(
  ...
  Widget _buildFilterPills(
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _buildPill(context, 'All Apps', true, primaryColor, theme),
          const SizedBox(width: 8),
          _buildPill(context, 'User Installed', false, primaryColor, theme),
          const SizedBox(width: 8),
          _buildPill(context, 'System', false, primaryColor, theme),
          const SizedBox(width: 8),
          _buildPill(context, 'Large Size', false, primaryColor, theme),
        ],
      ),
    );
  }
